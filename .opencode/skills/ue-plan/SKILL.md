...
Order tasks by dependency. Identify independent code tasks that can be delegated in parallel to `ue-code-writer`. Keep asset editing tasks sequential for `ue-asset-editor`, especially JsonToAsset, Unreal Remote Execution, package saves, and editor-driven operations.
...
- Acceptance criteria.
- Verification.
- Suggested agent: primary agent, `ue-code-writer`, `ue-asset-editor`, or `ue-tester`.
...
- Suggested Agent: <ue-code-writer | ue-asset-editor | ue-tester | primary>
